                        ...
                        <div class="col-xs-10 col-sm-10 col-md-2">
                            <div class="navbar-header">
                                <?php if ($boas_opt['show_logo']): ?>
                                    <a rel="home" class="navbar-brand" href="<?php echo esc_url(home_url('/')); ?>" title="<?php bloginfo('name'); ?>"><img class="logo-img" src="<?php echo $boas_opt['logo_url']['url'] ?>" alt="<?php bloginfo('name'); ?>"/></a>
                                <?php else: ?>
